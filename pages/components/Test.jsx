...
import { 
  ...
  FaSnapchat, FaPinterest, FaWhatsapp, FaTelegram, FaChartBar,
  FaAd, FaSearch, FaFileAlt, FaVideo, FaCamera, FaPalette, FaTrademark,
  FaBullhorn, FaUsers, FaChartLine, FaRocket, FaFire, FaHashtag,
  FaHeart, FaUserFriends, FaChartPie, FaSeedling, FaExchangeAlt, FaPercentage,
  FaChartArea
} from 'react-icons/fa';
    ...
    <div className="w-full overflow-hidden md:h-[90vh] h-[28rem] relative flex justify-end items-center flex-col bg-black text-white border-b-2">
          ...
          {[...Array(31)].map((_, index) => {
            ...
            return (
              <motion.div 
                ...
                style={{
                  transform: `rotate(${angle}deg) translate(${isMobile ? '2rem' : '36rem'})`,
                  transformOrigin: 'center',
                  backgroundColor: 'rgba(255, 255, 255, 0.9)'
                }}
              >
                <Icon className="md:w-12 md:h-12 w-6 h-6 rotate-90" style={{ color: color }} />
              </motion.div>
            );
          })}
        </div>
      ...
      <div className="w-full flex justify-center items-center flex-col pb-20 px-4">
        ...
        <p className="font-normal max-w-4xl text-center z-20 my-6 md:text-lg text-sm text-gray-300">
          Transform your brand with our cutting-edge social media management and content creation services. 
          From viral campaigns to engaging content, we help you connect with your audience and drive real results.
        </p>
